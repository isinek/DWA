	...
	<section class="container content">
		<div class="row">
			...
			<div class="col-md-9 col-sm-12">
				...
				<a href="#" class="btn btn-primary" style="float: right; margin-right: 10px;" onclick="printToPdf(jQuery(this));">Spremi PDF</a>
                <a href="#" class="btn btn-primary" style="float: right; margin-right: 10px;">Grafički prikaz</a>
